          ...
          <div className="col-md-8 col-lg-6">
            <div className="card border-0 shadow-lg text-center p-4 p-md-5 rounded-4 animate__animated animate__zoomIn mt-4">
              ...
              <p className="text-muted mb-4">
                Cảm ơn em đã tin tưởng Beans Café. Đơn hàng đang được pha chế
                ngay!
              </p>
              ...
              {orderData ? (
                <div className="bg-light p-4 rounded-3 text-start mb-4 border border-dashed">
                  <h6
                    className="fw-bold border-bottom pb-2 mb-3 text-uppercase"
                    style={{ color: "#6F4E37" }}
                  >
                    Chi tiết đơn hàng
                  </h6>
              ...
              <div className="d-grid gap-2 d-md-flex justify-content-md-center mt-4">
                <Link
                  to="/menu"
                  className="btn btn-espresso px-4 py-2 rounded-pill fw-bold border-0 shadow-sm transition-hover"
                >
                  TIẾP TỤC CHỌN MÓN
                </Link>
                <Link
                  to="/order-history"
                  className="btn btn-outline-dark px-4 py-2 rounded-pill fw-bold border-2 transition-hover"
                >
                  LỊCH SỬ ĐƠN HÀNG
                </Link>
              </div>
