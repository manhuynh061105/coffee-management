    ...
    <div className="menu-page" style={{ backgroundColor: "#F8F9FA" }}>
      ...
      >
        <div className="container animate__animated animate__fadeIn">
          <h1
            className="display-3 fw-bold text-white text-uppercase mb-2"
          ...
          <div
            ...
            style={{ width: "80px", height: "4px", backgroundColor: "#D2691E" }}
          ></div>
          <p className="fs-5 text-white-50 italic">
            Khám phá hương vị cà phê mộc thượng hạng tại Beans Café
          </p>
        </div>
      </div>
          ...
          {filteredProducts.length > 0 ? (
            filteredProducts.map((item) => (
              <div key={item._id} className="col-lg-3 col-md-6 col-12">
                <div
                  className="card h-100 border-0 shadow-sm menu-item-card-premium overflow-hidden"
                  style={{ borderRadius: "25px" }}
                >
                  <div
                    className="position-relative overflow-hidden p-3"
                    style={{ height: "240px" }}
                  >
                    <img
                  ...
                  <div className="card-body text-center d-flex flex-column px-4 pb-4 pt-0">
                    ...
                    <div className="d-grid gap-2">
                      ...
                      >
                        <i className="fa-solid fa-cart-shopping me-2"></i>ĐẶT
                        HÀNG
                      </button>
                      <Link
                        to={`/product/${item._id}`}
            ...
            <div className="col-12 text-center my-5 py-5 animate__animated animate__fadeIn">
              <div className="mb-3">
                <i className="fa-solid fa-mug-hot display-1 text-muted opacity-25"></i>
              </div>
              <h3 className="text-muted fw-light">
                Rất tiếc, Beans Café chưa có món này!
              </h3>
              <button
